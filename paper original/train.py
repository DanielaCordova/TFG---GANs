...
if __name__ == '__main__':
    ...
    parser.add_argument("--start_depth", action="store", type=int, default=5,
                        help="Starting depth for training the network")
    
    parser.add_argument("--generator_file", action="store", type=str, default="F:\data\hzh\checkpoints\StyleGAN.pytorch\ckp_celeba_6\models\GAN_GEN_3_4.pth",
                        help="pretrained Generator file (compatible with my code)")
    parser.add_argument("--gen_shadow_file", action="store", type=str, default="F:\data\hzh\checkpoints\StyleGAN.pytorch\ckp_celeba_6\models\GAN_GEN_SHADOW_3_4.pth",
                        help="pretrained gen_shadow file")
    parser.add_argument("--discriminator_file", action="store", type=str, default="F:\data\hzh\checkpoints\StyleGAN.pytorch\ckp_celeba_6\models\GAN_DIS_3_4.pth",
                        help="pretrained Discriminator file (compatible with my code)")
    parser.add_argument("--gen_optim_file", action="store", type=str, default="F:\data\hzh\checkpoints\StyleGAN.pytorch\ckp_celeba_6\models\GAN_GEN_OPTIM_3_4.pth",
                        help="saved state of generator optimizer")
    parser.add_argument("--dis_optim_file", action="store", type=str, default="F:\data\hzh\checkpoints\StyleGAN.pytorch\ckp_celeba_6\models\GAN_DIS_OPTIM_3_4.pth",
